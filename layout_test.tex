...
\hypersetup{pageanchor=true}
{
	...
	\normalsize \tableofcontents \vfill \eject
	\ifthenelse{\isodd{\value{page}}}{}{\rule{0cm}{15cm}\vfill\eject}
}

% Seitenzählung mit arabischen Zahlen\left
\pagenumbering{arabic}

% Kopfzeile aus Seitennummer und der Überschrift des laufenden Abschnittes
\pagestyle{headings}

% input fügt die angegebene Datei als Teil des Quelltextes ein. Dabei erfolgt kein Seitenvorschub
