...
\begin{equation}
\varphi = \frac{2\pi}{\Phi_0}Ut + \varphi_0 = w_\mathrm{J}t + \varphi_0 \ \ \  \mathrm{mit} \ \ \ \frac{2\pi}{\Phi_0}U = w_\mathrm{J}
\end{equation}

folgt. Demnach oszilliert der Strom $I_\mathrm{s}$ mit der \textit{Josephson-Frequenz} $f_\mathrm{J} = \frac{w_\mathrm{J}}{2\pi U} = \frac{1}{\Phi_0} \approx 483.6 \ \frac{\mathrm{MHz}}{\mu V}  
