...
Here, we introduced the dimensionless screening paramater $\beta_{\rm L}=\frac{2L_{\rm s}I_{\rm c}}{\unit{\fq}}$, which relates the maximum possible flux produced by screening currents 
