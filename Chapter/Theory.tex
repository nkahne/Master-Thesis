...
\twofigurescenter {t!}
{width=0.48\textwidth}
{../Figures/HDSQ7w1_2B20_05_6p0um_1-2_fabienneMA}
{0.02\textwidth} %hspace b/w figures
{width=0.48\textwidth}
{../Figures/JJoverdamped}
{0.5cm} %vspace
{Left: Measured IVC of an underdamped junction manufactured in this working group by \cite{Bauer2018}, showing the typical hysteresis. Right: Theoretical IVC of an overdamped junction with a current-voltage shape that is independent of the current sweep direction.}
{IVCs}
