...
\gl{
I_{\rm tot} = 2 I_{\mathrm{c}} \cos \left(\pi \frac{\Phi_{\rm e}}{\Phi_0}\right) \sin \left(\varphi_1+\pi \frac{\Phi_{\rm e}}{\Phi_0}\right) + 2\frac{V_{\rm s}}{R} \ \ ,
}{}
...
\gl{
I_{\rm tot} = I_{\rm s}^m(\Phi_{\rm e}) \sin \left(\varphi\right) + \frac{2}{R}\frac{\unit{\fq}}{2\pi}\frac{\del\varphi}{\del t} \ \ .
}{}
